...
function serveStatic(res, pathname, rootDir) {
  ...
  res.writeHead(200, {
    ...
    // переспрашивать». Файлы крошечные, зато после выката никто не получит
    // старый CSS вперемешку с новым скриптом. Прежний max-age=300 давал ровно
    // это: пять минут разъехавшихся версий, которые невозможно объяснить.
