...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Ссылка действует 30 минут и работает один раз.</div>
...
<tr><td style="padding:22px 36px 0;">
  <h1 style="margin:0;font-size:22px;line-height:1.3;font-weight:600;color:#1c1b20;">Восстановление пароля</h1>
  <p style="margin:12px 0 0;font-size:15px;line-height:1.6;color:#46464f;">
    Кто-то запросил новый пароль. Если это были вы — перейдите по кнопке
    ниже. Ссылка действует 30 минут и работает один раз.
  </p>
</td></tr>
<tr><td style="padding:28px 36px 4px;">
  <table role="presentation" cellpadding="0" cellspacing="0"><tr>
    <td style="border-radius:9999px;background:#5b4fe0;">
      <a href="${safeLink}" style="display:inline-block;padding:14px 34px;font-size:15px;font-weight:600;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#ffffff;text-decoration:none;border-radius:9999px;">Сбросить пароль</a>
    </td>
  </tr></table>
</td></tr>
...
<tr><td style="padding:28px 36px 32px;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="border-top:1px solid #ece5d8;padding-top:18px;">
    <p style="margin:0;font-size:13px;line-height:1.5;color:#918f9a;">
      Не запрашивали сброс? Просто не открывайте письмо.
    </p>
  </td></tr></table>
</td></tr>
</table>
